...
contract HelperConfig is Script {
    ...
    function getOrCreateAnvilEthConfig() public returns (NetworkConfig memory) {
        ...
        vm.startBroadcast();
        address priceFeedAddress = address(new MockV3Aggregator(DECIMALS, INITIAL_ANSWER));
        vm.stopBroadcast();

        NetworkConfig memory anvilConfig = NetworkConfig({priceFeed: priceFeedAddress});
        return anvilConfig;
    }
}
